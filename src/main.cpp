...
int main () {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        uObjects.addSphereEmission(1, glm::vec3(0, 3, 0), 2, glm::vec3(4.0), 1);
        uObjects.addSphere(2, glm::vec3(-1,0,0), 0.5, glm::vec3(0.9), 0.05, 1.5);
        uObjects.addSphere(3, glm::vec3(1,0,0), 0.5, glm::vec3(0.8, 0.6, 0.7), 0.7);
        uObjects.addSphere(4, glm::vec3(0,0,-0.5), 0.5, glm::vec3(0.2, 1, 0.6), 1);
